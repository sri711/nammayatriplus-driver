...
import { X, Navigation, Clock, DollarSign, MapPin, Star, PhoneCall, ChevronUp, ChevronDown } from "lucide-react";
...
const RideRequest = ({
  ...
  }, [timeLeft, onDecline, request.id, toast]);
  ...
  return (
    <div 
      className={cn(
        "bg-white rounded-xl shadow-elevated animate-slide-up transition-all duration-300 overflow-hidden",
        isFullScreen ? "fixed inset-0 z-50" : "mx-auto max-w-md"
      )}
    >
      {/* Close Button (only for fullscreen) */}
